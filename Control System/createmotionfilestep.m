function [] = createmotionfilestep(motionfilename, initial_state, varargin)
...
statesheaderfilename = toolspathname + "states_header.txt";
outputstatesfilename = toolspathname + "SS_Results/arm26_states.sto";
motionheaderfilename = toolspathname + "motion_header.txt";
