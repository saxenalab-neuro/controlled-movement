 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Fri Jul 09 11:40:11 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME forwardtool
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            1
/* Input Port  0 */
#define IN_PORT_0_NAME        controls
...
extern void forwardtool_Outputs_wrapper(const real_T *controls,
			real_T *pv);
/*====================*
 * S-function methods *
 *====================*/
...
{
    const real_T *controls = (real_T *) ssGetInputPortRealSignal(S, 0);
    real_T *pv = (real_T *) ssGetOutputPortRealSignal(S, 0);

    forwardtool_Outputs_wrapper(controls, pv);
